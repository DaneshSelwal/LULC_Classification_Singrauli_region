...
var baseImage = s2.median().clip(aoi);
...
var legendItems = [
  ...
  {name: 'Agriculture', color: 'E6E600'},
  {name: 'Settlement', color: 'FF0000'},
  {name: 'Mining', color: '000000'},
  {name: 'Barren / Scrub', color: 'C2B280'},
...
for (var i = 0; i < legendItems.length; i++) {
  legend.add(makeLegendRow(legendItems[i].color, legendItems[i].name));
}
...
Export.image.toDrive({
  ...
  description: 'Singrauli_LULC_RF_Sentinel2_2024',
  folder: 'GEE_Exports',
  region: aoi,
  scale: 10,
  maxPixels: 1e13,
...
print('✅ Random Forest classified map export task created.');
